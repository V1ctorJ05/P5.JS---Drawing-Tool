...
strokeWeight(4);
stroke(51, mouseX, mouseY);
fill(113, mouseX, mouseY);
beginShape();
// shoulders (same width, aligned with head)
vertex(mouseX, 600); // left shoulder
vertex(620, mouseY); // right shoulder

// waist (wider at bottom)
vertex(mouseX, mouseY); // right waist
...
pop();
  ...
  strokeWeight(4);
  stroke(51);
  fill(211,mouseX,mouseY);
  ellipse(519, 430, 393, 542);
  
  //mouth
  push();
translate(520, mouseX, 597);   
rotate(360);          
stroke(mouseX, mouseY);            
strokeWeight(3);
fill(255);            
...
pop();
  ...
  //Left Eye
  arc(432, mouseX, 73, mouseY, 180, 0, OPEN);
...
fill(350, mouseX, 15);
beginShape();
vertex(510, mouseY); // top-left
vertex(520, 455); // top-mid
vertex(mouseX, 450); // top-right
